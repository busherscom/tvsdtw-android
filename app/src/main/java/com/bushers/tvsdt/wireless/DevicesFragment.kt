...
class DevicesFragment : ListFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (activity!!.packageManager.hasSystemFeature(PackageManager.FEATURE_BLUETOOTH)) bluetoothAdapter = BluetoothAdapter.getDefaultAdapter()
    ...
    override fun onListItemClick(l: ListView, v: View, position: Int, id: Long) {
        ...
        fragmentManager!!.beginTransaction().replace(R.id.fragment, fragment, "terminal").addToBackStack(
            null
        ).commit()
    }
